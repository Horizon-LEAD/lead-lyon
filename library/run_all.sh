...
rm -rf 01_synthetic_population/data/*
rm -rf 01_synthetic_population/output/*
rm -rf 01_synthetic_population/temp

rm -rf 02_parcel_generation/environment
rm -rf 02_parcel_generation/code
rm -rf 02_parcel_generation/input/*
rm -rf 02_parcel_generation/output/*
rm -rf 02_parcel_generation/temp
...
cp -r raw_data/* 01_synthetic_population/data # Move the raw input data
