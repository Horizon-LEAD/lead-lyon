...
public class RecordedTravelTime implements TravelTime {
	...
	static public RecordedTravelTime readFromEvents(File eventsPath, Network network, double startTime,
	...
	static public RecordedTravelTime readFromEvents(File eventsPath, Network network, Config config) {
	...
	static public RecordedTravelTime readFromEvents(File eventsPath, Network network, TravelTime fallback,
