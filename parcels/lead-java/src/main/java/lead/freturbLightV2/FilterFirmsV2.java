...
//        try (BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream("E:/lead/Marc/Freturb_Light/Input_Tabellen/idf_coords.csv")))){
...
//        try (BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream("D:/lead/Marc/Freturb_Light/Input_Tabellen/idf_coords.csv")))){
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream("C:/lead/Marc/Freturb_Light/Input_Tabellen/sirene/idf_coords.csv")))){
